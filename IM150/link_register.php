...
if (strtolower(substr($link_logo_src,0,4)) != 'http'){
	$link_logo_src = 'http://'.$link_logo_src;
}
if (strtolower(substr($link_url,0,4)) != 'http'){
	$link_url = 'http://'.$link_url;
}
if ($link_logo_src == 'http://' || $link_logo_src == 'https://')  $link_logo_src = '';
if ($link_url == 'http://' || $link_url == 'https://')  $link_url = '';
