...
<table class="formarea" width="100%">
	<tr>
		...
		<td align="right"><a href="javascript:void(0);" onClick="javascript:window.parent.scripts.restore_frames(); return false;"><? echo $lang['Refresh_Chat']?></a>&nbsp;|&nbsp;<a href="javascript:void(0);" onClick="javascript:window.parent.scripts.clear_frames(); window.parent.message_view.location='chatspot_help.<?php echo $phpEx; ?>'; return false;"><? echo $lang['Help']; ?></a>&nbsp;|&nbsp;<a href="javascript:void(0);" onClick="javascript:window.parent.scripts.clear_frames(); window.parent.message_view.location='chatspot_about.<?php echo $phpEx; ?>'; return false;"><? echo $lang['About']; ?></a>&nbsp;<?php if( $is_admin ) echo '|&nbsp;<a href="javascript:void(0);" style="color:red;" onClick="javascript:window.parent.scripts.clear_frames(); window.parent.message_view.location=\'chatspot_rooms.' .$phpEx . $SID . '\'; return false;">Rooms</a>&nbsp;'; ?>|&nbsp;<a href="javascript:void(0);" style="color:red;" onClick="javascript:window.parent.scripts.shut_down(); window.parent.scripts.clear_frames(); javascript:window.parent.scripts.leave_room(); return false;"><b>[<? echo $lang['Close']; ?>]</b></a></td>
		</tr>
		</table>
		</td>
	</tr>
