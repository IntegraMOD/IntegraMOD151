<?php
/**
* <b>CrackerTracker File: ct_footer.php</b><br><br>
* 
...
function create_footer_layout($ct_gfn)
{
	...
	switch( $ct_gfn )
	{
		...
		case 3:		$ctracker_footer_template = $footer_mini . '<br /><br />' . sprintf($lang['ctracker_fdisplay_g'], $counter_value_now);
					break;
					
		case 4:		$ctracker_footer_template = $footer_big . '<br /><br />' . sprintf($lang['ctracker_fdisplay_g'], $counter_value_now);
					break;
