...
<tr> 
	<td class="cat" align="center" colspan="' . ((isset($this->_tpldata['.'][0]['NUM_COLUMNS'])) ? $this->_tpldata['.'][0]['NUM_COLUMNS'] : '') . '"> 
		<span class="cattitle">' . ((isset($this->_tpldata['.'][0]['MODULE_NAME'])) ? $this->_tpldata['.'][0]['MODULE_NAME'] : '') . '</span> 
	</td> 
</tr> 
<tr>    
';// BEGIN column
$_column_count = (isset($this->_tpldata['column.'])) ?  sizeof($this->_tpldata['column.']) : 0;
if ($_column_count) {
...
';// BEGIN row
$_row_count = (isset($this->_tpldata['row.'])) ?  sizeof($this->_tpldata['row.']) : 0;
if ($_row_count) {
...
echo '
  <tr> 
';// BEGIN row_column
$_row_column_count = (isset($this->_tpldata['row.'][$_row_i]['row_column.'])) ? sizeof($this->_tpldata['row.'][$_row_i]['row_column.']) : 0;
...
} elseif ($this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['GRAPH_COLUMN']) { 
echo '
		<td class=';// IF row.row_column.ROW is even
if (!($this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['ROW'] % 2)) { 
echo '"row1"';// ELSE
...
echo ' align="' . ((isset($this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['ALIGNMENT'])) ? $this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['ALIGNMENT'] : '') . '" width="50%"> 
			<table cellspacing="0" cellpadding="0" border="0" align="left">
			<tr> 
				<td align="right"><img src="' . ((isset($this->_tpldata['.'][0]['LEFT_GRAPH_IMAGE'])) ? $this->_tpldata['.'][0]['LEFT_GRAPH_IMAGE'] : '') . '" width="4" height="12" /></td> 
			</tr> 
			</table> 
			<table cellspacing="0" cellpadding="0" border="0" align="left" width="' . ((isset($this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['VALUE'])) ? $this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['VALUE'] : '') . '%"> 
			<tr> 
				<td><img src="' . ((isset($this->_tpldata['.'][0]['GRAPH_IMAGE'])) ? $this->_tpldata['.'][0]['GRAPH_IMAGE'] : '') . '" width="100%" height="12" /></td> 
			</tr> 
			</table> 
			<table cellspacing="0" cellpadding="0" border="0" align="left"> 
			<tr> 
				<td align="left"><img src="' . ((isset($this->_tpldata['.'][0]['RIGHT_GRAPH_IMAGE'])) ? $this->_tpldata['.'][0]['RIGHT_GRAPH_IMAGE'] : '') . '" width="4" height="12" /></td> 
			</tr> 
			</table> 
		</td> 
	';// ELSE
...
echo ' align="' . ((isset($this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['ALIGNMENT'])) ? $this->_tpldata['row.'][$_row_i]['row_column.'][$_row_column_i]['ALIGNMENT'] : '') . '" width="10%">
