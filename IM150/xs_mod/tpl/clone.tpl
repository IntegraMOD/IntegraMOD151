...
<tr>
	<th class="thHead" colspan="4">{L_XS_CLONE_STYLES}</th>
</tr>
<tr>
...
<tr> 
	...
	<td class="{styles.ROW_CLASS}" align="center" valign="middle" nowrap="nowrap"><span class="gen"><a href="{styles.U_CLONE}">{L_XS_CLONE_STYLE_LC}</a></span></td>
</tr>
<!-- END styles -->
</table>
<br />