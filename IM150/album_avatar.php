 ...
 *                                album_avatar.php
 *                            -------------------
 *   begin                : Sunday, September 26th, 2004
 *   copyright            : (C) 2004 Nuffmon/Jeffreyt
 *
 ***************************************************************************/

/***************************************************************************
 *
 *   This script makes a pic (pic_id) in album_showpage as your profile avater
 *   by clicking a link. It also includes uploading it to your database, and
 *   deleting the avatar that the user has before. It also uses album config
 *   setting that has been set in your ACP.
 *
 ***************************************************************************/
...
$message = "Your profile avatar has been updated.<br />
						Click <a href='album_cat.$phpEx?cat_id=$cat_id&user_id=$user_id'>here</a> to go to image category.<br />
						Click <a href='album_showpage.$phpEx?pic_id=$pic_id&user_id=$user_id'>here</a> to go to image.<br />";
