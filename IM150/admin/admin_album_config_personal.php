...
$album_config_tabs[] =  array(
	...
	'template_file' => 'admin/album_config_personal_body.tpl'
	);
...
function album_generate_config_personal_box($config_data)
{
	...
	$template->assign_vars(array(
		...
		'PERSONAL_PICS_APPROVAL_ENABLED' => ($new['personal_pics_approval'] == 1) ? 'checked="checked"' : '',
		'PERSONAL_PICS_APPROVAL_DISABLED' => ($new['personal_pics_approval'] == 0) ? 'checked="checked"' : '',
