...
define('ALBUM_ACP_TEMPLATE', 'admin/album_config_body_extended.tpl' );
//define('ALBUM_ACP_TEMPLATE', 'admin/album_config_body_extended_vert.tpl');
//------------------------------------------------------------------------
