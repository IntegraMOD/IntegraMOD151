...
class JUpload {
    ...
    function JUpload($appletparams = array(), $classparams = array()) {
     ...
     */
    function logPHPDebug($function, $msg) {
	 ...
	 */
    function dstfinal(&$name, &$subdir) {
		$name = FM_Tools::utf8Decode($name, $this->classparams['encoding']);
   ...
   *
   */
    function defaultAfterUploadManagement() {
   ...
   */
    function generateAppletTag($str) {
   ...
   */
    function interceptBeforeUpload($str) {
	 ...
	 * This *must* be public, because it is called from PHP's output buffering.
	 */
    function interceptAfterUpload($str) {
   ...
   */
    function receive_uploaded_files() {
