...
$access = $info['zone_enchant'];

if ( $access == '0' )
	adr_previous( Adr_zone_building_noaccess , adr_zones , '' );
//
//END zone Enchant Restriction
//
...
if ( $mode != "" )
{
	switch($mode)
	{
		...
		case 'repair_action' :
			...
			$direction = append_sid("adr_enchant.$phpEx?mode=repair");
			$message .= '<br /><br />'.sprintf($lang['Adr_return'],"<a href=\"" . $direction . "\">", "</a>") ;
			message_die ( GENERAL_MESSAGE , $message );
		...
		case 'recharge_action' :
			...
			$direction = append_sid("adr_enchant.$phpEx?mode=recharge");
			$message .= '<br /><br />'.sprintf($lang['Adr_return'],"<a href=\"" . $direction . "\">", "</a>") ;
			message_die ( GENERAL_MESSAGE , $message );
		...
		case 'stone_action' :
			...
			$direction = append_sid("adr_enchant.$phpEx?mode=stone");
			$message .= '<br /><br />'.sprintf($lang['Adr_return'],"<a href=\"" . $direction . "\">", "</a>") ;
			message_die ( GENERAL_MESSAGE , $message );
		...
		case 'enchant_action' :
			...
			$direction = append_sid("adr_enchant.$phpEx?mode=enchant");
			$message .= '<br /><br />'.sprintf($lang['Adr_return'],"<a href=\"" . $direction . "\">", "</a>") ;
			message_die ( GENERAL_MESSAGE , $message );
...
$template->assign_vars(array(
	...
	'U_REPAIR_ITEM' => append_sid("adr_enchant.$phpEx?mode=repair"),
	'U_RECHARGE_ITEM' => append_sid("adr_enchant.$phpEx?mode=recharge"),
	'U_CREATE_ITEM' => append_sid("adr_enchant.$phpEx?mode=create"),
	'U_MINING' => append_sid("adr_enchant.$phpEx?mode=mining"),
	'U_STONE' => append_sid("adr_enchant.$phpEx?mode=stone"),
	'U_ENCHANT_ITEM' => append_sid("adr_enchant.$phpEx?mode=enchant"),
	'S_FORGE_ACTION'=> append_sid("adr_enchant.$phpEx"),
));
