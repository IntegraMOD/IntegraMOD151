...
//		if( ! array_key_exists('mini_cal_row.',$template->_tpldata) ){
    ...
    $prev_month = '<a href="' . append_sid($_SERVER["PHP_SELF"] . $prev_qs . $page) . '" class="gen"><img src="' . $images['mini_cal_icon_left_arrow'] . '" title="' . $lang['View_previous_month'] . '" border="0" alt="&lt;&lt;"></a>';
    $next_month = '<a href="' . append_sid($_SERVER["PHP_SELF"] . $next_qs . $page) . '" class="gen"><img src="' . $images['mini_cal_icon_right_arrow'] . '" title="' . $lang['View_next_month'] . '" border="0" alt="&gt;&gt;"></a>';
