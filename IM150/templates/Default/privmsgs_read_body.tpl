...
<td width="100%" class="row2"><table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		...
		<td align="right">{QUOTE_PM_IMG}{EDIT_PM_IMG} {REPORT_PM_IMG}
</td>
	</tr>
</table></td>
</tr>
...
<tr>
<td width="20%" valign="middle" nowrap="nowrap">{REPLY_PM_IMG}</td>
<td align="right" class="nav">&nbsp;<a href="{U_INDEX}">{L_INDEX}</a></td>
</tr>
</table>
</td>
</tr>
