...
<table width="100%" cellspacing="1" cellpadding="3" border="0" class="forumline">
	...
	<tr> 
		<td class="row2" width="20%" align="center" style="vertical-align:top;"><img src="{IMG_ICON_GLOB_MSG}" alt="{L_HEADLINE}" title="{L_HEADLINE}" border="0"></td>
...
<table width="100%" cellspacing="1" cellpadding="3" border="0" class="forumline">
	<tr> 
		<th colspan="2">{L_GLOBALMSG_RESET}</th>
	</tr>
	<tr> 
		<td class="row2" width="20%" align="center" style="vertical-align:top;"><img src="{IMG_ICON_GLOB_RES}" alt="{L_GLOBALMSG_RESET}" title="{L_GLOBALMSG_RESET}" border="0"></td>
		<td class="row1" width="80%" style="vertical-align:top;">{L_GLOB_RESET_TXT}</td>
	</tr>
	<tr>
		<td class="catBottom" colspan="2" align="center"><input type="Submit" name="pull_back" value="{L_RESET}" class="mainoption"></td>
	</tr>
</table>
</form>