...
<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="button" onclick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /><input type="checkbox" name="new_user">{L_CREATE_USER}
</td>
</tr>
</table>
</form>
