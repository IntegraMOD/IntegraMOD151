...
<form method="post" action="{S_MODE_ACTION}" name="delete_ids">
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<!-- END emptyrow -->
	<tr> 
	  <td class="cat" colspan="6" height="28" align="center"><input type="submit" class="mainoption" value="{L_DELETE}">&nbsp;&nbsp;<input type="reset" class="liteoption" value="{L_CLEAR}"></td>
	</tr>
  </table>
</form>
...
<form method="post" action="{S_MODE_ACTION}" name="delete_all_before">
  <table cellpadding="3" cellspacing="1" border="0" class="forumline" align="center">
  	<tr>
  		<td class="cat" colspan="3"><span class='catTitle'>{L_DELETE_FROM_EXPLAN}</span></td>
  	</tr>
	<tr>
