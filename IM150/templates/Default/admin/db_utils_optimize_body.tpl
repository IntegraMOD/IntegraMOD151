...
<tr>
	<td class="cat" align="center" valign="middle" colspan="6"><span class="cattitle">{L_CONFIGURATION}</span></td>
</tr>
...
<tr>
	<td colspan="6" height="1" class="spaceRow"><img src="../images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
	
<tr>
	<td class="cat" align="center" valign="middle"><span class="cattitle">{L_TABLE}</span></td>
	...
	<td class="cat" align="center" valign="middle"> &nbsp; &nbsp; </span></td>
</tr>	
