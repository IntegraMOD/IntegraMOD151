...
<!-- BEGIN ctrack_logoutput -->
  <tr>
    ...
    <td align="left" width="25%" class="{ctrack_logoutput.T_ROW_CLASS}">{ctrack_logoutput.L_C4}</td>
  </tr>
<!-- END ctrack_logoutput -->
  <tr height="30px">
    <td align="center" valign="center" colspan="5" class="row3"><b>{L_ANZ_ENTR}</b></td>
  </tr>
</table>
