...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr>
		<td class="cat" width="50%"><span class="gen"><input type="text" class="post" size="20" name="new_language" />&nbsp;<input type="submit" name="new_lang_submit" value="{L_CREATE_NEW_LANG}" class="liteoption" /></span></td> <!-- create new language, possible to choose an existing language as schema -->
		<td class="cat" width="5%" align="center" valign="middle"><span class="gen">&nbsp</span></td>
		...
		<td class="cat" align="center" valign="middle"><span class="gen"><a href="{U_LANG_COMPLETE_EXPORT}">{L_COMPLETE_EXPORT}</a></span></td> <!-- export: export everything -->
	</tr>
	<!-- BEGIN langrow -->
	<tr>
		<td class="row2" width="50%"><b><span class="gensmall"><a href="{langrow.U_COLLAPSE_DECOLLAPSE}" class="gensmall">{langrow.L_COLLAPSE_DECOLLAPSE}</a></span></b><span class="cattitle">&nbsp;{langrow.LANGUAGE}</span></td> <!-- Language Title, collapse/decollapse, default: collapsed -->
	...
	<!-- END modulerow -->
	<tr>
		<td colspan="5" height="1" class="spaceRow"><img src="../images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END langrow -->
	<tr>
		<td colspan="5" height="1" class="spaceRow"><img src="../images/spacer.gif" alt="" width="1" height="1" /></td>
