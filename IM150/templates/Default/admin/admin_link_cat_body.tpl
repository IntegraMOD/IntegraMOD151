...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	...
	<!-- END catrow -->
	<tr>
		<td class="cat" align="center" height="28" colspan="4"><input type="hidden" value="new" name="mode" /><input name="submit" type="submit" value="{L_CREATE_CATEGORY}" class="liteoption"></td>
	</tr>
</table>
</form>
