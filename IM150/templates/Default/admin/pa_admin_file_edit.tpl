...
<!-- INCLUDE pa_custom_field.tpl -->
  <tr>
	<td align="center" class="cat" colspan="2">{S_HIDDEN_FIELDS}<input class="mainoption" type="submit" value="{L_FILE_TITLE}" name="submit" onClick="set_mirror_mode(false);" /></td>
  </tr>
</table>
</form>