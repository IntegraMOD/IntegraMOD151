...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="99%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_EDIT_MODULE}</span></td>
	</tr>
	<tr> 
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="99%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_PERMISSIONS}</span></td>
	</tr>
	<tr> 
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="99%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_MODULE_INFORMATIONS}</span></td>
	</tr>
	<tr>
...
<form action="{S_ACTION_UPDATE}" method="post" enctype="multipart/form-data">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_UPDATE_MODULE}</span></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="cat" colspan="2" align="center">{S_SELECT_HIDDEN_FIELDS}{S_UPLOAD_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_UPDATE}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="liteoption" /></td>
	</tr>
</table></form>
