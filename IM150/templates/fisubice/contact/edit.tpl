...
{CONTACT_CP_LINKS}
				...
				<tr>
					<td colspan="3"><span class="nav">{TOTAL_TEXT}
					<br />{ALERT_EDIT}</span></td>
			...
			<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
				...
				<tr> 
					...
					<td class="{list.list_row.ROW_CLASS}" align="center" valign="middle"><span class="genmed"><input type="checkbox" name="mark[]2" value="{list.list_row.S_MARK_ID}"></span></td>
				</tr>
				<!-- END list_row -->
				<tr> 
					<td class="row2" align="right" colspan="5" valign="middle">
						<span class="genmed">
							...
							| {list.L_MOVE}
							<input type="submit" name="{list.MOVE_TYPE1}" value="{list.MOVE_1}" class="liteoption" />
							<input type="submit" name="{list.MOVE_TYPE2}" value="{list.MOVE_2}" class="liteoption" />
							<input type="submit" name="delete" value="{list.L_REMOVE_SELECTED}" class="mainoption" />
						</span>
					</td>
				</tr>
			</table>
