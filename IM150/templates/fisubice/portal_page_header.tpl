...
<div class="sp-col" id="header_hide" style="display: none;" valign="top" align="left" width="10" height="18"><a href="JavaScript:ShowHide('header_block','header_hide','header_block');"><img src="{layout_collapse.LAYOUT_IMAGER}" width="10" height="18" alt="" border="0" /></a></div>
<!-- END layout_collapse -->
