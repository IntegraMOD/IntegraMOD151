...
<table width="80%" cellspacing="1" cellpadding="3" border="0" class="forumline">
	<tr>
		<td align="center" style="background-color:#DBFFCF;"><b>{L_OK_MESSAGE}</b></td>
	</tr>
</table>
</div>
...
<table width="100%" cellspacing="1" cellpadding="3" border="0" class="forumline">
	...
	<tr>
		...
		<td class="row1" width="50%" align="center">{L_VAL_1}</td>
	</tr>
	<tr>
		<td class="row2" width="50%">{L_NAME_2}</td>
		<td class="row2" width="50%" align="center">{L_VAL_2}</td>
	</tr>
	<tr>
		<td class="row1" width="50%">{L_NAME_3}</td>
		<td class="row1" width="50%" align="center">{L_VAL_3}</td>
	</tr>
	<tr>
		<td class="row2" width="50%">{L_NAME_4}</td>
		<td class="row2" width="50%" align="center">{L_VAL_4}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row1" width="50%" align="center">{L_VAL_5}</td>
	</tr>
	<tr>
		<td class="row2" width="50%">{L_NAME_6}</td>
		<td class="row2" width="50%" align="center">{L_VAL_6}</td>
	</tr>
	<tr>
		<td class="row1" width="50%">{L_NAME_7}</td>
		<td class="row1" width="50%" align="center">{L_VAL_7}</td>
	</tr>
	<tr>
		<td class="row2" width="50%">{L_NAME_8}</td>
		<td class="row2" width="50%" align="center">{L_VAL_8}</td>
	</tr>
	<tr>
		<td class="row1" width="50%">{L_NAME_9}</td>
		<td class="row1" width="50%" align="center">{L_VAL_9}</td>
	</tr>
	<tr>
		<td class="row1" width="50%">{L_NAME_10}</td>
		<td class="row1" width="50%" align="center">{L_VAL_10}</td>
	</tr>
	<tr>
