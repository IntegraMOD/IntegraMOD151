...
<!-- BEGIN forum_tour -->
  <tr>
	<td align="right" valign="middle"><span class="nav">{forum_tour.PAGINATION}</span></td>
  </tr>
<!-- END forum_tour -->
  <tr>
	<td align="center" valign="middle"><input type="button" name="close" onClick="javascript:window.close()" value="{L_CLOSE_TOUR}"></td>
  </tr>
</table>