...
<tr>
<td class="nav"><a href="{U_INDEX}">{L_INDEX}</a>{NAV_SEPARATOR}{L_VIEWING_PROFILE}</td>
</tr>
</table>
...
<a href="{U_SEARCH_USER}">{L_SEARCH_USER_POSTS}</a><br /><a href="{U_PERSONAL_GALLERY}" class="genmed">{L_PERSONAL_GALLERY}</a></span></td>
</tr>
<tr>
