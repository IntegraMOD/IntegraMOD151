...
>
	...
	<tr>
		...
		class="row1"
		<!-- END background -->
		><div id="block1_{header_blocks_row.BLOCKID}" style="display: ''; position: relative;">{header_blocks_row.OUTPUT}</div></td>
	</tr>
	<!-- BEGIN openclose -->
	<tr>
		<td><a class="openclose" href="javascript:ShowHide('block1_{header_blocks_row.BLOCKID}','block2_{header_blocks_row.BLOCKID}','block3_{header_blocks_row.BLOCKID}');">&nbsp;</a></td>
	</tr>
	<!-- END openclose -->
</table>
<br />
