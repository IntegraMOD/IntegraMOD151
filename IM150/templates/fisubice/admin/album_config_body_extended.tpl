...
<table class="tab_border" width="100%" cellpadding="1" cellspacing="1" border="0">
	<tr>
		<!-- BEGIN header_row -->
		...
		<td colspan="{HEADER_COL_SPAN}">
			<form name="config" action="{S_ALBUM_CONFIG_ACTION}" method="post" onSubmit="return confirmSubmit();">
				...
				<table width="100%" cellpadding="1" cellspacing="1" border="0" class="forumline">
					...
					{CONFIGURATION_BOX}
					<tr>
						<td class="catBottom" colspan="2" align="center"><input type="submit" name="submitted" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" onclick="unsetChange();" class="liteoption" /></td>
					</tr>
				</table>
			</form>
		</td>
