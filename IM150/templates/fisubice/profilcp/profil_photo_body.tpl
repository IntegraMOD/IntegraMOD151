...
<tr>
	<td valign="top" align="center">
		...
		<tr> 
			<th colspan="2" valign="middle">{L_PHOTO_PANEL}</th>
		</tr>
		<tr>
		...
		<tr> 
			<td class="row1" width="50%"><span class="gen">{L_UPLOAD_PHOTO_FILE}:</span></td>
			<td class="row2" width="50%"><input type="hidden" name="MAX_FILE_SIZE" value="{PHOTO_SIZE}" /><input type="file" name="photo" class="post" style="width:200px" /></td>
		</tr>
		...
		<!-- BEGIN switch_photo_local_gallery -->
		<tr> 
			<td class="row1"><span class="gen">{L_PHOTO_GALLERY}:</span></td>
			<td class="row2"><input type="text" name="photolocal" size="40" class="post" style="width:200px">&nbsp;<input type="submit" name="photogallery" value="{L_SHOW_GALLERY}" class="liteoption" onClick="window.open('{U_PHOTO_SELECT}', '_phpbbphoto', 'HEIGHT=400,resizable=yes,scrollbars=yes,WIDTH=620');return false;" /></td>
		</tr>
		<!-- END switch_photo_local_gallery -->
		<tr>
