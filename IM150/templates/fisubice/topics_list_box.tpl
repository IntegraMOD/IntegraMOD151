<style>
/*
div.col, div.col-4, div.col-8, div.col-12 {border: 1px #000000 solid !important; }
...
<!-- END header_row -->
<!-- BEGIN topic -->
  <div class="row d-flex justify-content-end px-0">
	<div class="col nav nowrap ">
      ...
      <!-- END icon -->
	  <div class=" py-2 {topics_list_box.row.ROW_CLASS}">
	...
	<div class="col-1 pt-2 {topics_list_box.row.ROW_CLASS} ctr postdetails"><a href="{topics_list_box.row.U_POSTINGS_POPUP}" onclick="NewWindow(this.href,'PopupWin');return false" onfocus="this.blur()"; title="{L_POPUP_MESSAGE}">{topics_list_box.row.REPLIES}</a></div>
	<div class="col-2 pt-2 {topics_list_box.row.ROW_CLASS} ctr name">{topics_list_box.row.TOPIC_AUTHOR}</div>
	<div class="col-1 pt-2 {topics_list_box.row.ROW_CLASS} ctr postdetails">{topics_list_box.row.VIEWS}</div>
	<div class="col-2 pt-2 {topics_list_box.row.ROW_CLASS} postdetails" onclick="window.location.href='{topics_list_box.row.U_VIEW_TOPIC}'">{topics_list_box.row.LAST_POST_TIME}<br />{topics_list_box.row.LAST_POST_AUTHOR} {topics_list_box.row.LAST_POST_IMG}</div>
	<!-- BEGIN multi_selection -->
	<div class="col-1 pt-2 {topics_list_box.row.ROW_CLASS} postdetails"><input type="checkbox" name="{topics_list_box.FIELDNAME}[]{topics_list_box.row.BOX_ID}" value="{topics_list_box.row.FID}" onClick="javascript:check_uncheck_main_{topics_list_box.row.BOX_ID}();" {topics_list_box.row.L_SELECT} />XXX</div>
	<!-- END multi_selection -->
  </div>
<!-- END topic -->
<!-- BEGIN no_topics -->
...
<!-- BEGIN bottom -->
  <div class="row"> 
    <div class="col catBottom genmed gen pt-1 mx-0">{topics_list_box.row.FOOTER}</div>
  </div>
<!-- END bottom -->
<!-- BEGIN footer_table -->
</div>
