<form method="post" action="{S_RECORDS_DAYS_ACTION}">
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  <th width="80" align="center" height="25" class="thCornerL" nowrap="nowrap">&nbsp;{L_LW_USERNAME}&nbsp;</th>
	  <th width="20" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_CURRENCY}&nbsp;</th>
	  <th width="50" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_MONEY}&nbsp;</th>
	  <th width="20" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_PLUS_MINUS}&nbsp;</th>
	  <th width="80" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_TXNID}&nbsp;</th>
	  <th width="40" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_STATUS}&nbsp;</th>
	  <th width="60" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_LW_DATE}&nbsp;</th>
	  <th align="center" class="thCornerR" nowrap="nowrap">&nbsp;{L_LW_COMMENT}&nbsp;</th>
	</tr>
	<!-- BEGIN topicrow -->
	<tr> 
	  <td class="row1" align="center" valign="middle"><span class="postdetails">{topicrow.LW_USERNAME}</span></td>
	  <td class="row2" align="center" valign="middle"><span class="name">{topicrow.LW_CURRENCY}</span></td>
