				...
				<td>
					<table width="100" border="0" cellspacing="0" cellpadding="5">
						...
						<tr align="center" valign="middle">
							<!-- BEGIN smilies_col -->
							<td><img src="{smilies_row.smilies_col.SMILEY_IMG}" border="0" onclick="emoticon('{smilies_row.smilies_col.SMILEY_CODE}');javascript:window.close();" alt="{smilies_row.smilies_col.SMILEY_DESC}" title="{smilies_row.smilies_col.SMILEY_DESC}" /></a></td>
							<!-- END smilies_col -->
						</tr>
						<!-- END smilies_row -->
