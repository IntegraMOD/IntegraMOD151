		...
		<tr>
			...
			<td class="row2" align="center" valign="middle" width="20%">
				<table border="0" cellspacing="0" cellpadding="5">
					...
					<!-- BEGIN smilies -->
						<td align="center">
							<img src="{switch_comment_post.smilies.URL}" border="0" onclick="emoticon(' {switch_comment_post.smilies.CODE} ');" alt="{switch_comment_post.smilies.DESC}" title="{switch_comment_post.smilies.DESC}" />
						</td>
					<!-- BEGIN new_col -->
					</tr>
					<tr>
