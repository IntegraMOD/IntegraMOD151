...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
	<tr align="right">
		<td class="cat" colspan="2" height="28"><span class="nav"><a href="{U_VIEW_OLDER_POST}" class="nav">{L_VIEW_PREVIOUS_POST}</a> :: <a href="{U_VIEW_NEWER_POST}" class="nav">{L_VIEW_NEXT_POST}</a> &nbsp;</span></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="100%" align="center"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.POSTER_NAME}</b></span><br /><span class="postdetails">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.POSTER_AVATAR}<br /><br />{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}</span></td>
			</tr>
		</table></td>
	</tr>
	<tr> 
	...
	<tr>
		<td class="{postrow.ROW_CLASS}" width="100%" height="28" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top" align="right" nowrap="nowrap">{postrow.QUOTE_IMG}</td>
			</tr>
			<tr> 
				<td colspan="2"><hr /></td>
			</tr>
