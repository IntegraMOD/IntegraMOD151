...
<table width="98%" align="center" cellspacing="1" cellpadding="2" border="0">
	<tr>
		<td class="nav" align="left">
			...
			<a class="button_main" href="{U_MANAGE_PIC}" title="{L_MANAGE_PIC}"><span>{L_MANAGE_PIC}</span></a>
			<!-- END manage_personal_gal_folders -->
			<!-- BEGIN enable_view_toggle -->
			<a class="button_main" href="{U_TOGGLE_VIEW_ALL}" title="{L_TOGGLE_VIEW_ALL}"><span>{L_TOGGLE_VIEW_ALL}</span></a>
