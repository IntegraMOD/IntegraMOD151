...
{CONTACT_CP_LINKS}
			...
			<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
				...
				<tr>
					...
					<th class="thTop" nowrap="nowrap">&nbsp;</th>
					<th class="thTop" nowrap="nowrap">{L_ALERT}</th>
				</tr>
				<!-- BEGIN list_row -->
				<tr> 
					...
					<td class="{list.list_row.ROW_CLASS}" align="center" valign="middle"><span class="gen"><input type="hidden" name="users[]2" value="{list.list_row.S_MARK_ID}" /><input type="checkbox" name="mark[]2" value="{list.list_row.S_MARK_ID}" {list.list_row.S_CHECKED} /></span></td>
				</tr>
				<!-- END list_row -->
				<tr> 
					<td class="row2" align="right" colspan="5" valign="middle">
						<span class="genmed">
							...
							<input type="submit" name="alert_update" value="{L_SUBMIT}" class="mainoption" />
						</span>
					</td>
				</tr>
			</table>
