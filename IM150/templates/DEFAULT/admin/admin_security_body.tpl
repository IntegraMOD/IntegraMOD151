...
<table width="100%" class="forumline" align="center">
	...
	<tr>
		<td class="row1"><span class="genmed">{PS_L_PASS_MATCH}</span><br /><span class="gensmall">{PS_L_PASS_MATCH_E}</span></td>
		<td class="row2"><span class="genmed"><input type="radio" name="phpBBSecurity_use_password_match" value="1" {PS_PASS_MATCH_Y} /> {L_ENABLED}  <input type="radio" name="phpBBSecurity_use_password_match" value="0" {PS_PASS_MATCH_N} /> {L_DISABLED}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="genmed">{PS_L_PASS_LEN}</span><br /><span class="gensmall">{PS_L_PASS_LEN_E}</span></td>
		<td class="row2"><span class="genmed"><input type="radio" name="phpBBSecurity_use_password_length" value="1" {PS_PASS_LEN_Y} /> {L_ENABLED}  <input type="radio" name="phpBBSecurity_use_password_length" value="0" {PS_PASS_LEN_N} /> {L_DISABLED}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="genmed">{PS_L_PASS_LENGTH}</span></td>
		<td class="row2"><span class="genmed"><input type="text" value="{PS_PASS_LENGTH}" name="phpBBSecurity_password_min_length" class="post"></span></td>
	</tr>
	<tr>
