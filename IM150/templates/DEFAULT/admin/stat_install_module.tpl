...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="50%">
	<tr> 
	  <td class="cat" colspan="1" align="center" height="28"><span class="cattitle">{L_SELECT_MODULE}</span></td>
	</tr>
	<tr>
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="50%">
	<tr> 
	  <td class="cat" colspan="1" align="center" height="28"><span class="cattitle">{L_UPLOAD_MODULE}</span></td>
	</tr>
	<tr>
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="99%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_INSTALL_MODULE}</span></td>
	</tr>
	<tr>
