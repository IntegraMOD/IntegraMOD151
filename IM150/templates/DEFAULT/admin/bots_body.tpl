...
<table width="90%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<th nowrap="nowrap">{L_BOT_NAME}</th>
		<th nowrap="nowrap">{L_BOT_IP_OR_AGENT}</th>
		<th colspan="2" nowrap="nowrap">{L_BOT_OPTIONS}</th>
	</tr>
	...
	<tr>
		<td class="{pendingrow.ROW_CLASS}" width="50%">{pendingrow.BOT_NAME}</td>
		<td class="{pendingrow.ROW_CLASS}" width="20%" align="center" nowrap="nowrap">{pendingrow.IP_OR_AGENT}</td>
	...
	<tr>
		<td class="row2" align="center" colspan="4"><br />{nopendingrow.NO_BOTS}<br /><br /></td>
	</tr>
