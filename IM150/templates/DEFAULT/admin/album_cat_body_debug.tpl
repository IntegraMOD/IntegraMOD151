...
<tr>
	<th class="thLeft" colspan="{HEADER_INC_SPAN}" width="75%%">{L_ALBUM_TITLE} '{HEADER_INC_SPAN}'</th>
	<th class="thRight" colspan="3" width="25%">{L_ALBUM_ACTION} '3'</th>
</tr>
...
<!-- BEGIN cattitle -->
<tr>
	<td class="row3" colspan="{catrow.cattitle.INC_SPAN_ALL}">'{catrow.cattitle.INC_SPAN_ALL}'<span class="gensmall">{catrow.cattitle.CAT_DESCRIPTION}</span></td>
</tr>
<!-- END cattitle -->
...
<tr>
	<td colspan="{INC_SPAN_ALL}" class="catBottom">'{INC_SPAN_ALL}'
