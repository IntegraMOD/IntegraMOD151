...
<table width="100%" class="forumline" align="center">
	...
	<tr>
		<td class="row1"><span class="genmed">{L_GUEST}</span><br /><span class="gensmall">{L_GUEST_EXP}</span></td>
		<td class="row2"><input type="text" name="guest_sessions" class="post" size="5" value="{GUEST}" /></td>
	</tr>		
	<tr>
	...
	<tr>
		<td class="row2" colspan="2">{WARNING}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="row2" colspan="2">{BACK_TOTAL}</td>
	</tr>																			
	<tr>
