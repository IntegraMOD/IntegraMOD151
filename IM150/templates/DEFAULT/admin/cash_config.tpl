...
<form action="{S_CASH_CONFIG_ACTION}" method="post"><input type="hidden" name="set" value="general"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
	  <th class="thHead" colspan="2">{L_CASH_SETTINGS}</th>
	</tr>
	...
	<tr>
	  <th class="thHead" colspan="2">{L_MESSAGES}</th>
	</tr>
	<tr>
	...
	<tr>
	  <th class="thHead" colspan="2">{L_SPAM}</th>
	</tr>
	<tr>
