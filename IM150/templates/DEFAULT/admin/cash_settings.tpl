...
<form action="{S_CASH_SETTINGS_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
	  <th class="thHead" colspan="{NUM_COLUMNS}">{L_DISPLAY}</th>
	</tr>
	<tr>
...
<!-- END cashrow -->
	...
	<tr>
	  <th class="thHead" colspan="{NUM_COLUMNS}">{L_IMPLEMENTATION}</th>
	</tr>
...
<!-- END cashrow -->
	...
	<tr>
	  <th class="thHead" colspan="{NUM_COLUMNS}">{L_ALLOWANCES}</th>
	</tr>
	<tr>
	  <th class="thHead" colspan="{NUM_COLUMNS}"><span class="gensmall">{L_ALLOWANCES_EXPLAIN}</span></th>
	</tr>
...
<!-- END cashrow -->
	...
	<tr>
		<td class="catBottom" colspan="{NUM_COLUMNS}" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="liteoption" />
		</td>
	</tr>
