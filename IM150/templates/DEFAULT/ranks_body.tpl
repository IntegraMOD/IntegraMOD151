...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr> 
		<td class="maintitle">{L_RANKS}</td>
	</tr>
	<tr> 
	<td align="left" valign="middle" width="100%"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a>{NAV_SEPARATOR}{L_RANKS}</span></td>
  </tr>
</table>
...
<tr>
	...
	<td valign="top" width="50%">
		...
		<tr>
			<td class="cat" nowrap="nowrap" align="center"><span class="cattitle">&nbsp;{L_RANKS}&nbsp;</span></td>
	...
	<td valign="top" width="50%">
		...
		<tr>
			<td class="cat" nowrap="nowrap" align="center"><span class="cattitle">&nbsp;{L_SPECIAL_RANKS}&nbsp;</span></td>
