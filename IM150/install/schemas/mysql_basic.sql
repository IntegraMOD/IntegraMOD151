...
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, `view`, layout, `cache`, cache_time, block_bbcode_uid, `type`, border, titlebar, openclose, background, `local`, groups) VALUES(33, 'Welcome', '<div style="width:100%"><img src="images/phpbbintegramod.jpg" style="display: block;width: 100%; height: auto;max-width:530px;margin:0 auto;overflow:hidden" /></div>', 'c', 1, 1, '', 0, 2, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, `view`, layout, `cache`, cache_time, block_bbcode_uid, `type`, border, titlebar, openclose, background, `local`, groups) VALUES(34, 'Welcome to IntegraMOD', '<div style="width:100%"><img src="images/phpbbintegramod.jpg" style="display: block;width: 100%; height: auto;max-width:530px;margin:0 auto;overflow:hidden" /></div>', 'c', 1, 1, '', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
