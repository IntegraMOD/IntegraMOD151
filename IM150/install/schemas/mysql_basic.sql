...
# -- Demo Topic
INSERT INTO phpbb_topics (topic_id, topic_title, topic_poster, topic_time, topic_views, topic_replies, forum_id, topic_status, topic_type, topic_vote, topic_first_post_id, topic_last_post_id) VALUES (1, 'Welcome to IntegraMOD 1.4.1 :)', 2, '972086460', 0, 0, 1, 0, 0, 0, 1, 1);
...
INSERT INTO phpbb_themes (themes_id, template_name, style_name, head_stylesheet, body_background, body_bgcolor, body_text, body_link, body_vlink, body_alink, body_hlink, tr_color1, tr_color2, tr_color3, tr_class1, tr_class2, tr_class3, th_color1, th_color2, th_color3, th_class1, th_class2, th_class3, td_color1, td_color2, td_color3, td_class1, td_class2, td_class3, fontface1, fontface2, fontface3, fontsize1, fontsize2, fontsize3, fontcolor1, fontcolor2, fontcolor3, span_class1, span_class2, span_class3, img_size_poll, img_size_privmsg) VALUES (1, 'DEFAULT', 'DEFAULT', 'stylesheet.css', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'row1', 'row2', '', '', '', '', 0, 0, 0, '', '006600', 'ff0000', '', '', '', 0, 0);
...
#
# Dumping data for table IM Portal Layout
#
...
#
# Dumping data for table IM Portal blocks
#
...
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(35, 'Topics Since', '', 'c', 2, 1, 'blocks_imp_topics_since', 2, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(36, 'Shoutbox', '', 'c', 3, 1, 'blocks_imp_shoutbox', 2, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(37, 'Referers', '', 'c', 4, 1, 'blocks_imp_referers', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(38, 'News', '', 'c', 6, 1, 'blocks_imp_news', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(39, 'Announcements', '', 'c', 5, 1, 'blocks_imp_announcements', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(40, 'Random Attach', '', 'c', 7, 0, 'blocks_imp_random_attach', 2, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(41, 'Calendar', '', 'r', 1, 1, 'blocks_imp_calendar', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(42, 'Site Survey', '', 'r', 2, 1, 'blocks_imp_poll', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(43, 'clock', '', 'r', 3, 1, 'blocks_imp_clock', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(44, 'Statistics', '', 'r', 4, 1, 'blocks_imp_statistics', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(45, 'Links', '', 'r', 5, 1, 'blocks_imp_links', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(46, 'Active Users', '', 'r', 6, 1, 'blocks_imp_users_visited', 0, 3, 1, 280, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(47, 'Visit Counter', '', 'r', 7, 1, 'blocks_imp_visit_counter', 0, 3, 1, 280, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(48, 'Board Navigation', '', 'l', 2, 1, 'blocks_imp_menu', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(49, 'Style Select', '', 'l', 1, 1, 'blocks_imp_style_select', 0, 3, 1, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(50, 'Second Menu', '', 'l', 3, 1, 'blocks_imp_sec_menu', 0, 3, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(51, 'Search', '', 'l', 4, 1, 'blocks_imp_search', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(52, 'security', '', 'l', 5, 1, 'blocks_imp_security', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(53, 'User Info', '', 'l', 6, 1, 'blocks_imp_user_block', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(54, 'Who is Online', '', 'l', 7, 1, 'blocks_imp_online_users', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(55, 'Recent Topics', '', 'l', 8, 1, 'blocks_imp_recent_topics', 2, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(56, 'Donations', '', 'l', 9, 1, 'blocks_imp_donate', 0, 3, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(57, 'Welcome to IntegraMOD', '<table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td align="center"><img src="images/phpbbintegramod.jpg" align="center"></td></tr></table>', 't', 1, 1, '', 0, 4, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(58, 'Style Select', '', 'd', 1, 1, 'blocks_imp_style_select', 0, 4, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(59, 'Board Navigation', '', 'c', 1, 1, 'blocks_imp_menu', 0, 4, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(60, 'Second Menu', '', 'c', 2, 1, 'blocks_imp_sec_menu', 0, 4, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(61, 'clock', '', 'd', 2, 1, 'blocks_imp_clock', 0, 4, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(62, 'Calendar', '', 'd', 3, 1, 'blocks_imp_calendar', 0, 4, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(63, 'Statistics', '', 'd', 4, 1, 'blocks_imp_statistics', 0, 4, 1, 10000, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(64, 'Referers', '', 'b', 1, 1, 'blocks_imp_referers', 0, 4, 0, 280, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(65, 'Shoutbox', '', 'b', 2, 1, 'blocks_imp_shoutbox', 0, 4, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(66, 'Shoutbox', '', 'b', 1, 1, 'blocks_imp_shoutbox', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
...
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(68, 'Board Navigation', '', '1', 1, 1, 'blocks_imp_menu', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(69, 'Second Menu', '', '1', 2, 1, 'blocks_imp_sec_menu', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(70, 'Calendar', '', '6', 1, 1, 'blocks_imp_calendar', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(71, 'Statistics', '', '5', 1, 1, 'blocks_imp_statistics', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(72, 'Who is Online', '', '6', 3, 1, 'blocks_imp_online_users', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(73, 'clock', '', '6', 2, 1, 'blocks_imp_clock', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(74, 'Recent Articles', '', '2', 1, 1, 'blocks_imp_recent_articles', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(75, 'Recent Topics', '', '2', 2, 1, 'blocks_imp_recent_topics', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(76, 'User Info', '', '3', 1, 1, 'blocks_imp_user_block', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(77, 'Links', '', '4', 1, 1, 'blocks_imp_links', 0, 6, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
...
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(79, 'Security', '', 'l', 1, 1, 'blocks_imp_security', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(80, 'Style Select', '', 'l', 2, 1, 'blocks_imp_style_select', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(81, 'Board Navigation', '', 'l', 3, 1, 'blocks_imp_menu', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(82, 'Second Menu', '', 'l', 4, 1, 'blocks_imp_sec_menu', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(83, 'Announcements', '', 'c', 1, 1, 'blocks_imp_announcements', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(84, 'News', '', 'c', 2, 0, 'blocks_imp_news', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(85, 'Referers', '', 'c', 4, 1, 'blocks_imp_referers', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(86, 'Recent Topics', '', 'c', 3, 1, 'blocks_imp_recent_topics', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(87, 'Calendar', '', 'r', 1, 1, 'blocks_imp_calendar', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(88, 'Site Survey', '', 'r', 2, 1, 'blocks_imp_poll', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(89, 'User Info', '', 'r', 4, 1, 'blocks_imp_user_block', 0, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');
INSERT INTO phpbb_blocks (bid, title, content, bposition, weight, active, blockfile, view, layout, cache, cache_time, block_bbcode_uid, type, border, titlebar, openclose, background, local, groups) VALUES(90, 'Chatbox', '', 'r', 3, 1, 'blocks_imp_chat', 2, 5, 0, 0, '', 0, 1, 1, 1, 1, 1, '');

#
# Dumping data for table IM Portal Block Position
#
...
INSERT INTO phpbb_hacks_list VALUES (15, 'Complete banner', 'This mod makes it posible to add banners to your phpbb2 pages, by default banners are placed in top/botton but you may place the tags, inside any template file.', 'Niels Chr. Rød', 'ncr@db9.dk', 'http://mods.db9.dk', '1.3.4', 'No', 'http://mods.db9.dk', '', 1168727612);
...
INSERT INTO phpbb_hacks_list VALUES (19, 'IntegraMOD', 'A pre-modded version of phpBB which integrates the best and most useful phpBB modifications.', 'masterdavid', 'webmaster@integramod.com', 'http://www.integramod.com', '1.4.1f', 'No', 'http://www.integramod.com', '', 1168727612);
...
INSERT INTO phpbb_hacks_list VALUES (44, 'Fully integrated shoutbox', 'A fully phpBB2 enabled shoutbox', 'Niels Chr. Rød', 'ncr@db9.dk', 'http://mods.db9.dk ', '1.0.10', 'No', 'http://mods.db9.dk ', '', 1168727612);
...
INSERT INTO phpbb_hacks_list VALUES (69, 'Prune users', 'Admin plug-in that makes it posible to delete users who are inactive/haven\\''t posted or like.', 'Niels Chr. Rød', 'ncr@db9.dk', 'http://mods.db9.dk', '1.4.3', 'No', 'http://mods.db9.dk', '', 1168727612);
...
INSERT INTO phpbb_hacks_list VALUES (81, 'Yellow card', 'Warning and ban system', 'Niels Chr. Rød', 'ncr@db9.dk', 'http://mods.db9.dk', '1.4.11', 'No', 'http://mods.db9.dk', '', 1168727612);
