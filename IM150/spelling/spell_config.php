<?php
  ...
  //
  // This is (c)Copyright 2002-2004, Team phpSpell.
  // --------------------------------------------------------------------

  define ('PHPSPELL_CONFIG', true);
  define ('PHPSPELL_VERSION', '1.06o');
  define ('LINE_FEED', "\n");
...
//  $Spell_Config['DB_Type'] = 'phpMail';
  ...
  // ----------------------------------------------
  $Spell_Config['Languages_Supported'] = array('English', 'Nederlands', 'Deutsch', 'Francais');
  ...
  if (isset($Spell_Config['DB_Type']) && ($Spell_Config['DB_Type'] == 'PHPBB' || $Spell_Config['DB_Type'] == 'PHPNuke')) {
    ...
    $Spell_Config['CSS'] = '../templates/fisubice/fisubice.css';
  ...
  if (isset($Spell_Config['DB_Type']) && $Spell_Config['DB_Type'] == 'Hivemail') {
  ...
  if (isset($Spell_Config['DB_Type']) && $Spell_Config['DB_Type'] == 'PSPELL') {
    include 'spell_pspell.php';
  }

  if (isset($Spell_Config['DB_Type']) && $Spell_Config['DB_Type'] == 'Invision')
  {
   ...
   if (isset($Spell_Config['DB_Type']) && $Spell_Config['DB_Type'] == 'vBulletin')
  {
    include '../config.php';
  ...
  if (isset($Spell_Config['DB_Type']) && $Spell_Config['DB_Type'] == 'phpMail')
  {
