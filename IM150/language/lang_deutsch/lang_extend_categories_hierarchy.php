...
if ( $lang_extend_admin )
{
	...
	$lang['Yes']									= 'Yes';
	$lang['No']										= 'No';
	$lang['Forum_points']							= 'Disable ' . $board_config['points_name'];
}

$lang['Category_locked'] 			= 'Diese Kategorie ist gesperrt, du kannst keine Beiträge editieren, oder Themen bearbeiten.';
$lang['Forum_link']					= 'Link-Umleitung';
$lang['Forum_link_visited']			= 'Dieser Link wurde %d mal besucht';
$lang['Redirect']					= 'Umleiten';
