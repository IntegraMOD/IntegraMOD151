...
$lang['Import_new_language_explain'] = 'Here you are able to upload (or select) the Language Pack you want to install. After you have uploaded (or selected) the Language Pack, you will see some information about the Language Pack. Only after viewing this information the Pack will be installed.';
