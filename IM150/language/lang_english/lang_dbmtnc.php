...
$lang['Thereof_deactivated_users'] = 'Deactivated users';
...
$lang['Authenticate_methods_help_text'] = 'You have to authenticate to do any changes on the board configuration. There are two ways to do so:
	First, you can authenticate by entering name and password of any active administrator account of the board (prefered method). Second, you can
...
$lang['cbl_success_anonymous'] = 'The ban list and the disallowed users were cleared successful. The anonymous account has
	been recreated. Since group data of the anonymous account may be missing, it is recommended to use the function
	&quot;Check user and group tables&quot; in the main part of DB Maintenance.';
...
$lang['rcp_success'] = "Copy the text to a text file, rename it to <b>config.$phpEx</b> and upload it to the root directory of the forum. Please
...
$lang['Option_Help_Text'] = '<p>If you get reported that there was an error creating a session or so, you can clear the session data by
	selecting <b>Clear all sessions</b>. If you have Problems with accessing database tables, you can repair the tables by selecting
	<b>Repair database tables</b>.</p>
	<p>If you are not able to log on or to enter the admin panel, there may be a fault in your path or your cookie settings. You can
	...
	<p>If you lost the password of your account, you can grant an user admin privileges by selecting <b>Grant user admin privileges</b>.
	This will also activate the user so you can use an user just created before. If you are not able to add a new user, you can clear the
	ban list with <b>Clear ban list</b> (this will also restore the anonymous user).</p>
