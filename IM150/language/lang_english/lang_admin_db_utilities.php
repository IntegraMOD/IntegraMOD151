<?php
/***************************************************************************
 *                       lang_admin_db_utilities.php [English]
 *                            -------------------
...
$lang['Optimize_explain'] = 'Here it\'s possible to optimize the contained data in the tables of the database. You can eliminate in this way the parts of the data that contain some empty spaces.<br />This operation must regularly be performed to make your database more reliable and to maintain a speed of correct execution.';
