...
del_pagefields = array(	
	...
	$lang['Wiz_backups_description'] = 'Here you can backup your PCP Files and delete or restore a backup.';
	$lang['Wiz_backups_explain'] = '<span class="explaintitle">Backup</span>: displays the date and the filename of the backup.<br><span class="explaintitle">Action</span>: what to do with the file.<br><span class="explaintitle">Restore</span>: Restores the selected file after backing up the current version.<br><span class="explaintitle">Delete</span>: Deletes the selected backup.<br><span class="explaintitle">View</span>: Shows the selected backup.<br><span class="explaintitle">Backup Now!</span>: Creates a backup of both /profilcp/def/def_userfields.php and /profilcp/def/def_usermaps.php.<br>';
	$lang['Restore'] = 'Restore';
	$lang['File_deleted'] = 'Successfully deleted the file: %s';
	$lang['File_restored'] = 'Successfully restored the file: %s';
	$lang['backupnow'] = 'Backup Now!';
	$lang['Backups_created'] = 'Backup files created';
}
