...
$lang['Pending_Explain'] = "Listed below are users that matched some but not all of your bot criteria. In other words the user only matched either the user agent or ip. The mismatched info is listed next to the bot name. You can choose to either add this info which will then appear as part of that bots criteria or ignore it.";
