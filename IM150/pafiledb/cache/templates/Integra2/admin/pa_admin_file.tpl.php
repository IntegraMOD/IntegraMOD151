...
<h1><?php echo ((isset($this->_tpldata['.'][0]['L_FILE_TITLE'])) ? $this->_tpldata['.'][0]['L_FILE_TITLE'] : ((isset($lang['FILE_TITLE'])) ? $lang['FILE_TITLE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'FILE_TITLE'))) . ' 	}')); ?></h1>

<p><?php echo ((isset($this->_tpldata['.'][0]['L_FILE_EXPLAIN'])) ? $this->_tpldata['.'][0]['L_FILE_EXPLAIN'] : ((isset($lang['FILE_EXPLAIN'])) ? $lang['FILE_EXPLAIN'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'FILE_EXPLAIN'))) . ' 	}')); ?></p>
...
<table width="100%" cellpadding="3" cellspacing="1" class="forumline">
  <tr>
	...
	<input type="submit" class="liteoption" name="addfile" value="<?php echo ((isset($this->_tpldata['.'][0]['L_ADD_FILE'])) ? $this->_tpldata['.'][0]['L_ADD_FILE'] : ((isset($lang['ADD_FILE'])) ? $lang['ADD_FILE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'ADD_FILE'))) . ' 	}')); ?>" onClick="set_add_file(true); set_delete_file(false);" />
	<input type="submit" class="liteoption" name="delete" value="<?php echo ((isset($this->_tpldata['.'][0]['L_DELETE_FILE'])) ? $this->_tpldata['.'][0]['L_DELETE_FILE'] : ((isset($lang['DELETE_FILE'])) ? $lang['DELETE_FILE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'DELETE_FILE'))) . ' 	}')); ?>" onClick="set_add_file(false); set_delete_file(true);" />
