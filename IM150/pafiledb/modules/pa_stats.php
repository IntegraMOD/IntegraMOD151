...
class pafiledb_stats extends pafiledb_public
{
	function main($action)
	{
		...
		$lang['Stats_text'] = str_replace("{u_newest_file}", append_sid("dload.php?action=file&file_id=" . $newest['file_id']), $lang['Stats_text']);
		$lang['Stats_text'] = str_replace("{newest_file}", $newest['file_name'], $lang['Stats_text']);
		$lang['Stats_text'] = str_replace("{u_oldest_file}", append_sid("dload.php?action=file&file_id=" . $oldest['file_id']), $lang['Stats_text']);
		...
		$lang['Stats_text'] = str_replace("{u_popular}", append_sid("dload.php?action=file&file_id=" . $popular['file_id']), $lang['Stats_text']);
		...
		$lang['Stats_text'] = str_replace("{u_lpopular}", append_sid("dload.php?action=file&file_id=" . $lpopular['file_id']), $lang['Stats_text']);
		...
		$lang['Stats_text'] = str_replace("{u_most_dl}", append_sid("dload.php?action=file&file_id=" . $mostdl['file_id']), $lang['Stats_text']);
...
// MX
			$pafiledb_template->assign_block_vars("downloads_os", array(
				'OS_IMG' => "pafiledb/images/stats/" . $os_image[$index],
...
// MX
			$pafiledb_template->assign_block_vars("downloads_b", array(
				'B_IMG' => "pafiledb/images/stats/" . $agent_image[$index],
