...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="95%">
	<tr>
		<td class="catHead" align="center" colspan="2"><span class="gen">{L_ITEM_DONATION}</span></td>
	</tr>
</table>
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="90%">
	<tr>
		<td class="row1" width="40%"><span class="gen">{L_GIVE_TO}</span></td>
		<td class="row2" align="center">{GIVE_TO}</td>
	</tr>
</table>
