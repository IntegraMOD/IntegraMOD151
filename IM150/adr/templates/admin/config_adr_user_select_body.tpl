...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	</form><form method="post" name="post" action="{S_USER_ACTION}">
	<tr>
		<td class="row1" align="center">{CHARS_LIST}&nbsp;<input type="hidden" name="mode" value="edit" /><input type="submit" name="submituser" value="{L_LOOK_UP}" class="mainoption" /></td>
	</tr>
</table>
