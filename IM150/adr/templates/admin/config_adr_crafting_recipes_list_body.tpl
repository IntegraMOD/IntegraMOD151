...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	<tr>
		...
		<th align="center">{L_RECIPE_SKILL}</th>
	...
	<tr class="gen">
		...
		<td class="{recipes.ROW_CLASS}" align="center">{recipes.RECIPE_SKILL}</td>
	...
	<form method="post" action="{S_RECIPES_ACTION}">
	<tr>
		<td class="catBottom" colspan="10" align="center">{S_HIDDEN_FIELDS}<input type="submit" value="{L_RECIPES_ADD}" class="mainoption" /></td>
	</tr>
</table>
