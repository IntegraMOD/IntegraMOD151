...
$sql = "SELECT user_id, username, user_email, user_viewemail, user_lang  
	FROM " . USERS_TABLE . " 
	WHERE user_id = $user_id";	
if ( $result = $db->sql_query($sql) )
{
	...
	//-- mod : profile cp 
	/* PCP Extra :: Altered
	if ( $row['user_viewemail'] || is_admin($userdata) )*/
	if ( pcp_get_class_check('email', $row) || is_admin($userdata) ) {
