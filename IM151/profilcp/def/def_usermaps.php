...
$user_maps = array(
	...
	'PHPBB.privmsgs.buttons' => array(
						...
						'username' => array(
								'img'          => true,
								'style'        => '<td valign="absbottom" nowrap="nowrap"><span class="genbtn"><i class="fa fa-user"></i>&nbsp;%s</span></td>',
							),
						'user_birthday' => array(
								'img'          => true,
						...
						'user_pm' => array(
								'img'          => true,
								'style'        => '<td valign="absbottom" nowrap="nowrap"><span class="genbtn"><i class="fa fa-envelope-square"></i>&nbsp;%s</span></td>',
							),
						'user_album' => array(
								'img'          => true,
								'style'        => '<td valign="absbottom" nowrap="nowrap"><span class="genbtn"><i class="fa fa-image"></i>&nbsp;%s</span></td>',
							),
						'user_email' => array(
								'img'          => true,
								'style'        => '<td valign="absbottom" nowrap="nowrap"><span class="genbtn"><i class="fa fa-user"></i>&nbsp;%s</span></td>',
	...
	'PHPBB.viewtopic.buttons' => array(
						...
						'username' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-solid fa-user">&nbsp;</span>%s</li>&nbsp;',
							),
						'user_birthday' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-solid fa-cake-candles"></span>%s</li>&nbsp;',
							),
						'user_my_friend' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="gensmall"></span>%s</li>',
							),
						'user_my_ignore' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="gensmall"></span>%s</li>',
						...
						'user_pm' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-solid fa-comments">&nbsp;</span>%s</li>&nbsp;',
							),
						'user_album' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-regular fa-image">&nbsp;</span>%s</li>&nbsp;',
							),
						'user_email' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-regular fa-envelope">&nbsp;</span>%s</li>&nbsp;',
							),
						'user_website' => array(
								'img'          => true,
								'style'        => '<li class="pcpvt"><span class="fa fa-solid fa-earth-americas"></span>%s</li>&nbsp;',
							),
						'user_aim' => array(
								'img'          => true,
	...
	'PHPBB.viewtopic.left' => array(
				'order'		=> 10,
						...
						'user_online' => array(
								'img'          => true,
								'style'        => '<div class="text-center"><i class="fa fa-solid fa-circle-user fa-xs"></i>%s</div>',
							),
						'user_rank_title' => array(
								'txt'          => true,
								'img'          => true,
