...
//-- fin mod : keep unread -------------------------------------------------------------------------
	...
	/* Hide Buttons :: Altered
	$quote_img = '<a href="' . $temp_url . '" title="' . $lang['Reply_with_quote'] . '"><img src="' . $images['icon_quote'] . '" alt="' . $lang['Reply_with_quote'] . '" title="' . $lang['Reply_with_quote'] . '" /></a>';*/
	if($is_auth['auth_reply']){ 
        $quote_img = '<a href="' . $temp_url . '" title="' . $lang['Reply_with_quote'] . '"><img src="' . $images['icon_quote'] . '" alt="' . $lang['Reply_with_quote'] . '" title="' . $lang['Reply_with_quote'] . '" /></a>'; 
    }
	$quote = '<a href="' . $temp_url . '" title="' . $lang['Reply_with_quote'] . '">' . $lang['Reply_with_quote'] . '</a>';
