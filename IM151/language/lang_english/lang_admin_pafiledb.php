...
$lang['Catexplain'] = 'You can use the Category Management section to add, edit, delete and rearrange categories. In order to add files to your database, you must have at least one category created. You can select a link below to manage your categories.'; 
...
$lang['Max_char_info'] = 'If someone has posted a comment in which there are more characters than this number, it will give them an error message (Limit the comment).';
