...
$lang['Required_explain'] = '&nbsp;<span style="color:red">*</span> = required field.';
...
$lang['Visible_board_email_all'] = '<br><i>(emails are always hidden and all users can send you an email through the board)</i>';
$lang['Visible_board_email_friends'] = '<br><i>(emails are always hidden and only friends can send you an email through the board)</i>';
...
$lang['Warnings'] = 'Yellow Cards: %d'; //shown beside users post, if any warnings given to the user
$lang['user_warnings'] = 'Yellow Cards'; // field label
