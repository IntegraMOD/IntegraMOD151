 ...
 *
 *   $Id: admin_pa_file.php,v 1.7 2004/01/04 15:58:06 jonohlsson Exp $
 *
 *
 ***************************************************************************/
...
$pafiledb_template->assign_vars(array(
			...
			'S_FILE_ACTION' => append_sid("dload.php?action=mcp"))
);
...
//		$where_sql = ($mode == 'file_cat') ? "AND file_catid = '$cat_id'" : '';
	...
	$pafiledb_template->assign_vars(array(
		...
		'PAGINATION' => generate_pagination(append_sid("dload.php?action=mcp&amp;mode=$mode&amp;sort_method=$sort_method&amp;sort_order=$sort_order&cat_id=$cat_id"), $total_files, $pafiledb_config['settings_file_page'], $start),
