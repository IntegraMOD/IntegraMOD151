...
$template->set_filenames(array(
	'nuffimage_box' => 'album_nuffimage_box.tpl'
	)
);
...
$template->assign_vars(array(
	...
	'U_NUFFIMAGE_ACTION' => append_sid(album_append_uid("album_showpage." . $phpEx . "?pic_id=" . $pic_id . $full_size_param . "&amp;nuffimage=true")),
