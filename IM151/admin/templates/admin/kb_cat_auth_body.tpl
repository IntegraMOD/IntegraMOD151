...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	<tr>
		...
		<!-- <th class="thTop" nowrap="nowrap">{L_APPROVAL}</th>
		<th class="thTop" nowrap="nowrap">{L_APPROVAL_EDIT}</th> -->
	...
	<tr>
		...
		<!--
		<td class="row2" align="center">
		<input name="approval[]" type="checkbox" {grouprow.APPROVAL_CHECKED} value="{grouprow.GROUP_ID}" />
		</td>
		<td class="row2" align="center">
		<input name="approval_edit[]" type="checkbox" {grouprow.APPROVAL_EDIT_CHECKED} value="{grouprow.GROUP_ID}" />
		</td>
		-->
		<td class="row2" align="center">
