...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="50%">
	<tr> 
	  <td class="cat" colspan="1" align="center" height="28"><span class="cattitle">{L_SELECT_LANGUAGE}</span></td>
	</tr>
	<tr>
		<td class="row1" align="center"><span class="gen">{S_SELECT_LANGUAGE}</span></td>
	</tr>
	<tr>
		<td class="cat" colspan="1" align="center">{S_SELECT_HIDDEN_FIELDS}
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="50%">
	<tr> 
	  <td class="cat" colspan="1" align="center" height="28"><span class="cattitle">{L_UPLOAD_LANGUAGE}</span></td>
	</tr>
	<tr>
		<td class="row1" align="center"><span class="gen"><input type="file" name="package" size="20" value="" class="post"></span></td>
	</tr>
	<tr>
		<td class="cat" colspan="1" align="center">{S_UPLOAD_HIDDEN_FIELDS}
		<input class="mainoption" name="submit" type="submit" value="{L_SUBMIT}" /></td>
	</tr>
</table></form>
...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="99%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_INSTALL_LANGUAGE}</span></td>
	</tr>
	<tr> 
