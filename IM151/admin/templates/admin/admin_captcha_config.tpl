...
<form action="{S_CAPTCHA_CONFIG_ACTION}" method="post"><table width="100%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1"><b>{L_EXAMPLE_CODE}</b><br /><span class="gensmall">{L_EXAMPLE_CODE_EXPLAIN}</span></td>
		<td class="row2" width="50%"><input class="post" type="text" maxlength="10" size="11" name="exsample_code" value="{EXAMPLE_CODE}" /></td>
	</tr>
	...
	<tr>
		<td class="row1"><b>{L_TRANS_LETTERS}</b><br /><span class="gensmall">{L_TRANS_LETTERS_EXPLAIN}</span></td>
		<td class="row2"><input type="radio" name="trans_letters" value="1" {S_TRANS_LETTERS_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="trans_letters" value="0" {S_TRANS_LETTERS_NO} /> {L_NO}</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="row1"><b>{L_BG_TRANSITION}</b><br /><span class="gensmall">{L_BG_TRANSITION_EXPLAIN}</span></td>
		<td class="row2"><input class="post" type="text" maxlength="3" size="4" name="bg_transition" value="{BG_TRANSITION}" />&nbsp;%</td>
	</tr>
	<tr>
