...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="forumline" align="center">
	...
	<tr>
		<td class="row1" rowspan="4"><span class="gen">&nbsp;
			<!-- BEGIN up -->
			<a href="{group_color_edit.U_WEIGHT_UP}" title="{L_UP}" class="gen"><i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></i>
</a><br /><br />
			<!-- END up -->
			<!-- BEGIN down -->
			<a href="{group_color_edit.U_WEIGHT_DOWN}" title="{L_DOWN}" class="gen"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
			<!-- END down -->
		</span></td>
