...
<tr><th class="thHead" colspan="2">{L_ALBUM_NUFFLOAD_CONFIG}</th></tr>
<tr>
	<td class="row1">
...
<tr><th class="thHead" colspan="2">{L_PROGRESS_BAR_CONFIG}</th></tr>
<tr>
...
<tr><th class="thHead" colspan="2">{L_MULTIPLE_UPLOADS_CONFIG}</th></tr>
<tr>
...
<tr><th class="thHead" colspan="2">{L_RESIZE_PICS_CONFIG}</th></tr>
<tr>
