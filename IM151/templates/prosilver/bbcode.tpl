...
<!-- BEGIN code_open --><dl class="codebox"><dt>{L_CODE}: <a href="#" onclick="selectCode(this); return false;">< ></a></dt><dd><code><!-- END code_open -->
...
<!-- BEGIN size_open --><span style="font-size: {SIZE}px; line-height: 116%"><!-- END size_open -->
