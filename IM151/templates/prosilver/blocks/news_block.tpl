<table width="100%" cellspacing="1" cellpadding="0" border="0">
  <tr>
    <td>
	  <!-- BEGIN pagination -->
      <div class="nav" style="float: right;text-align: right; padding: 0px; margin: 10px 0 10px 20px; clear: both;">{pagination.PAGINATION}</div>
	  <!-- END pagination -->
      <div class="nav" style=" padding: 0; margin: 10px 0;"><a href="{INDEX_FILE}" alt="Index">{L_INDEX}</a> | <a href="{INDEX_FILE}?news=categories" alt="Index">{L_CATEGORIES}</a> | <a href="{INDEX_FILE}?news=archives" alt="Index">{L_ARCHIVES}</a></div>
      <!-- BEGIN categories -->
      <div style="border: #ddd solid 1px; float: left; padding: 10px; margin: 10px;"><a href="{INDEX_FILE}?cat_id={categories.ID}"><img style="border: 0" src="{categories.IMAGE}" alt="{articles.TITLE}" /></a></div>
      <!-- END categories -->
      <!-- BEGIN arch -->
      ...
      <div style="border: #aaaaaa solid 1px; padding: 10px; margin-bottom: 10px; clear: both;">
        <div style="float: right; padding: 5px; margin: 5px;"><a href="{INDEX_FILE}?cat_id={articles.CAT_ID}"><img src="{articles.CAT_IMG}" alt="{articles.CATEGORY}" style="border: 0" /></a></div>
      ...
      <div style="border: #ddd solid 1px; padding: 10px; margin: 10px 0 10px 20px; clear: both;">
        ...
        <hr />
        <div class="postbody">{comments.BODY}</div>
      </div>
      <!-- END comments -->
      <!-- BEGIN pagination -->
      <hr />
      <div class="navbr" style="text-align: right; padding: 0px; margin: 10px 0 10px 20px; clear: both;">{pagination.PAGINATION}</div>
      <!-- END pagination -->
    </td>
  </tr>
</table>