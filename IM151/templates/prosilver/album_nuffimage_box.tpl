...
<table class="forumline" width="98%" align="center" cellspacing="1" cellpadding="2">
	...
	<tr>
		<td class="row1" width="2%" align="center"><img src="{IMG_NORMAL}" border="0" alt="" /></td>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_resize" value="1" {NUFF_RESIZE_CHECKED} /></td>
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_rotation" value="1" {NUFF_ROTATE_CHECKED} /></td>
		<td class="row1" width="45%">
		...
		<td class="row2" width="2%" align="center">&nbsp;</td>
		<td class="row1" width="2%" align="center"><img src="{IMG_RECOMPRESS}" border="0" alt="" /></td>
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_recompress" value="1" {NUFF_RECOMPRESS_CHECKED} /></td>
		<td class="row1" width="45%">
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_mirror" value="1" {NUFF_MIRROR_CHECKED} /></td>
		<td class="row1" width="45%"><span class="gen"><b>{L_NUFF_MIRROR}</b><br /><br />{L_NUFF_MIRROR_EXPLAIN}</span></td>
		<td class="row2" width="2%" align="center">&nbsp;</td>
		<td class="row1" width="2%" align="center"><img src="{IMG_FLIP}" border="0" alt="" /></td>
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_flip" value="1" {NUFF_FLIP_CHECKED} /></td>
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_interlace" value="1" {NUFF_INTERLACE_CHECKED} /></td>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_screen" value="1" {NUFF_SCREEN_CHECKED} /></td>
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_bw" value="1" {NUFF_BW_CHECKED} /></td>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_sepia" value="1" {NUFF_SEPIA_CHECKED} /></td>
		<td class="row1" width="45%"><span class="gen"><b>{L_NUFF_SEPIA}</b><br /><br />{L_NUFF_SEPIA_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1" width="2%" align="center"><img src="{IMG_BLUR}" border="0" alt="" /></td>
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_blur" value="1" {NUFF_BLUR_CHECKED} /></td>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_scatter" value="1" {NUFF_SCATTER_CHECKED} /></td>
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_pixelate" value="1" {NUFF_PIXELATE_CHECKED} /></td>
		<td class="row1" width="45%"><span class="gen"><b>{L_NUFF_PIXELATE}</b><br /><br />{L_NUFF_PIXELATE_EXPLAIN}</span></td>
		<td class="row2" width="2%" align="center">&nbsp;</td>
		<td class="row1" width="2%" align="center"><img src="{IMG_STEREOGRAM}" border="0" alt="" /></td>
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_stereogram" value="1" {NUFF_STEREOGRAM_CHECKED} /></td>
	...
	<tr>
		...
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_infrared" value="1" {NUFF_INFRARED_CHECKED} /></td>
		<td class="row1" width="45%"><span class="gen"><b>{L_NUFF_INFRARED}</b><br /><br />{L_NUFF_INFRARED_EXPLAIN}</span></td>
		<td class="row2" width="2%" align="center">&nbsp;</td>
		<td class="row1" width="2%" align="center"><img src="{IMG_TINT}" border="0" alt="" /></td>
		<td class="row2" width="2%" align="center"><input type="checkbox" name="nuff_tint" value="1" {NUFF_TINT_CHECKED} /></td>
	...
	<tr>
		<td class="row3" width="100%" align="center" colspan="7">
			<span class="gen"><input type="submit" value="{L_SUBMIT}" class="mainoption" /></span>
		</td>
	</tr>
</table>
</form>
