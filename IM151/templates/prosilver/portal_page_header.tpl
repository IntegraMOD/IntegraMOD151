...
<td id="header_block" style="display: ''; width:{HEADER_WIDTH}px" valign="top">
		...
		<div class="forabg">
			...
			<ul class="topiclist">
				<li class="header">
					<dl class="icon">
					<!-- BEGIN title -->
						<dt>{header_blocks_row.title.TITLE}</dt>
					<!-- END title -->

					<!-- BEGIN title_image -->
						<dd style="position: relative; Float: right;"><img src="{header_blocks_row.title_image.TITLE}" /></dd>
					<!-- END title_image -->
...
<!-- The button that is shown when the block is open.  Note that it is within the
		collapsible cell and therefore disappears when the block closes -->
								...
								<div onclick="ShowHide('block1_{header_blocks_row.BLOCKID}','block2_{header_blocks_row.BLOCKID}','block1_{header_blocks_row.BLOCKID}');" style="width:100%; cursor: pointer; cursor: hand;">
									<img src="{header_blocks_row.openclose.CLOSE_IMG}" />
								</div>
								<!-- END openclose -->
