		...
		<h2>{L_PROFILE}</h2>
		<form id="postform" action="{S_POST_ACTION}" method="post" name="post" onsubmit="return checkForm(this)">
		<div class="panel bg3">
		...
		<!-- END switch_not_privmsg -->
				...
				<dl style="clear: left;">
					...
					<dd><input type="text" name="subject" size="25" maxlength="60" value="{SUBJECT}" class="inputbox autowidth" /></dd>
				</dl>
