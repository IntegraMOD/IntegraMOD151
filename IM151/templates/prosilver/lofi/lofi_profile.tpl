  ...
  <tr> 
	<td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<tr> 
		  ...
		  <td class="row1" valign="middle"><b><span class="gen">{PM}</span></b></td>
		</tr>
		<tr> 
		...
		<tr> 
		  ...
		  <td class="row1" valign="middle"><span class="gen">{YIM}</span></td>
		</tr>
		<tr> 
		  <td valign="middle" nowrap="nowrap" align="right"><span class="gen">{L_AIM}:</span></td>
		  <td class="row1" valign="middle"><span class="gen">{AIM}</span></td>
		</tr>
		<tr> 
		...
		if ( navigator.userAgent.toLowerCase().indexOf('mozilla') != -1 && navigator.userAgent.indexOf('5.') == -1 && navigator.userAgent.indexOf('6.') == -1 )
			...
			document.write('<table cellspacing="0" cellpadding="0" border="0"><tr><td nowrap="nowrap"><div style="position:relative;height:18px"><div style="position:absolute">{ICQ}</div><div style="position:absolute;left:3px;top:-1px">{ICQ_STATUS}</div></div></td></tr></table>');
		  
		  //--></script><noscript>{ICQ}</noscript></td>
		</tr>
	  </table>
	</td>
  </tr>
