...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
		<td class="cat" align="center"><b>{L_DAYS}</b></td>
	      <td class="cat" align="center" nowrap><b>{L_PRUNE_ACTION}</b></td> 
		<td class="cat" align="center" nowrap="nowrap"><b>{L_PRUNE_LIST}</b></td>
	</tr>
<!-- BEGIN prune_list -->
	<tr> 
