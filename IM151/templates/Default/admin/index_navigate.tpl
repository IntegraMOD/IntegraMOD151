...
menuVersion += ' &copy; 2004<br />by <a href="http://www.phpmix.com/" target="_blank" class="copyright">phpMiX</a> Modified by <a href="http://www.webmedic.net/" target="_blank" class="copyright">webmedic</a>';
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr> 
<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="{TEMPLATE}images/logo_phpBB_med.png" alt="" width="122" height="56" vspace="4" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
...
<tr> 
<td class="row1"><a href="{U_ADMIN_INDEX}" target="main" class="genmed">{L_ADMIN_INDEX}</a></td>
</tr>
<tr> 
<td class="row1"><a href="{U_FORUM_INDEX}" target="_parent" class="genmed">{L_FORUM_INDEX}</a></td>
</tr>
<tr> 
<td class="row1"><a href="{U_FORUM_INDEX}" target="main" class="genmed">{L_PREVIEW_FORUM}</a></td>
</tr>
<tr> 
<td class="row1"><a href="{U_PORTAL_INDEX}" target="_parent" class="genmed">{L_PORTAL_INDEX}</a></td>
</tr>
<tr> 
...
<!-- BEGIN modulerow -->
<tr> 
<td class="row1"><div id="menuCat_{catrow.MENU_CAT_ID}_{catrow.modulerow.ROW_COUNT}" style="display:block;"><a href="{catrow.modulerow.U_ADMIN_MODULE}"  target="main" class="genmed">{catrow.modulerow.ADMIN_MODULE}</a></div>
</td>
</tr>
<!-- END modulerow -->
					</table>
