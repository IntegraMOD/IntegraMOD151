...
<table width="100%" cellspacing="1" cellpadding="4" border="0">
	<tr> 
		<th  colspan="7" height="25">{L_GROUP_INFORMATION}</th>
	</tr>
	<tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="catSides" colspan="8" height="28"><span class="cattitle"><b>{L_GROUP_MODERATOR}</b></span></td>
	</tr>
	<tr> 
	  <td class="row1" align="center"><span class="gen"> {MOD_PM} </td>
	  ...
	  <td class="row1" align="center" valign="middle"><span class="gen">{MOD_EMAIL}</span></td>
	  <td class="row1" align="center">{MOD_WWW}</td>
	  <td class="row1" align="center"> &nbsp; </td>
	</tr>
	<tr> 
	  <td class="catSides" colspan="8" height="28"><span class="cattitle"><b>{L_GROUP_MEMBERS}</b></span></td>
	</tr>
	<!-- BEGIN member_row -->
	<tr> 
