...
<tr>
<td class="tbtl"><img src="{TEMPLATE}images/spacer.gif" alt="" width="22" height="22" /></td>
<td class="tbtbot"><b></b><span class="gen">
<a href="{catrow.U_VIEWCAT}" class="cattitle">{catrow.CAT_DESC}</a></span></td><td class="tbtr"><img src="{TEMPLATE}images/spacer.gif" alt="" width="124" height="22" /></td></tr></table>
...
<tr onclick="window.location.href='{topics_list_box.row.U_VIEW_TOPIC}'" style="cursor: pointer; cursor: hand">
	...
	<td class="row1" onMouseOver="this.className='row2'" onMouseOut="this.className='row1'"  align="center" valign="middle" nowrap="nowrap" onclick="window.location.href='{topics_list_box.row.U_VIEW_TOPIC}'" style="cursor: pointer; cursor: hand"><span class="postdetails">{topics_list_box.row.LAST_POST_TIME}<br />{topics_list_box.row.LAST_POST_AUTHOR} {topics_list_box.row.LAST_POST_IMG}</span></td>
	<!-- BEGIN multi_selection -->
