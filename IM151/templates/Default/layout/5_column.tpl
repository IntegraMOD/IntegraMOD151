...
>
	...
	<tr>
		...
		class="row1"
		<!-- END background -->
		><div id="block1_{left_blocks_row.BLOCKID}" style="position: relative;">{left_blocks_row.OUTPUT}</div><!-- BEGIN openclose --><a class="openclose" href="javascript:ShowHide('block1_{left_blocks_row.BLOCKID}','block2_{left_blocks_row.BLOCKID}','block3_{left_blocks_row.BLOCKID}');">&nbsp;</a><!-- END openclose --></td>
	</tr>
</table>
<br />
