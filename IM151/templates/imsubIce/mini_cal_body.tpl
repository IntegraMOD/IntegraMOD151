	...
	<table width="100%" cellpadding="0" cellspacing="1" border="0" class="forumline shadow">
	  <tr>
		<td align="center" class="cat" height="28">
		  <span class="cattitle">
	  ...
	  <!-- BEGIN switch_mini_cal_events -->
	  <tr>
		<td class="cat" height="28"><span class="cattitle">{L_MINI_CAL_EVENTS}</span></td>
	  </tr>
	  <!-- END switch_mini_cal_events -->
	  ...
	  <!-- BEGIN switch_mini_cal_add_events -->
	  <tr>
		<td class="row1" height="28" align="center"><span class="genmed">{S_MINI_CAL_EVENTS_FORUMS_LIST} <input type="submit" value="{L_MINI_CAL_ADD_EVENT}" class="liteoption" /><input type="Hidden" name="mode" id="mode" value="newtopic" /></span></td>
	  </tr>
	  <!-- END switch_mini_cal_add_events -->
	</table>
	<!-- BEGIN switch_mini_cal_add_events -->
