  <div class="container-fluid px-0">
    ...
    <div class="row"> 
      <div class="col pl-0 text-start maintitle"><a href="{U_VIEW_FORUM}">{FORUM_NAME}</a></div>
...
{BOARD_ANNOUNCES}
  ...
  <div class="container-fluid px-0">
    <div class="row"> 
      <div class="col">
        <!-- BEGIN is_auth_post --> 
	    <a class="postbtn" href="{U_POST_NEW_TOPIC}"><i class="fa-solid fa-file-signature"></i>&nbsp;{L_POST_NEW_TOPIC}</a>
	    <!-- END is_auth_post -->
      </div>
      <div class="col navbr text-end">
	    <!-- BEGIN switch_banner_13 -->
	    {BANNER_13_IMG}<br />
	    <!-- END switch_banner_13 -->
      </div>
      <div class="col pt-1 text-end gensmall"><b>{PAGINATION}</b><br />{PAGE_NUMBER}</div>
    </div>
  </div>
...
{TOPICS_LIST_BOX}
  ...
  <div class="container-fluid mx-0">
    <div class="row"> 
      <div class="col-2 nw text-start px-0"><a class="postbtn" href="{U_POST_NEW_TOPIC}"><i class="fa-solid fa-file-signature"></i>&nbsp;{L_POST_NEW_TOPIC}</a></div>
 	  <div class=""></div>
      <div class="col mb-0 pr-0 text-end gensmall"><b>{PAGINATION}</b><br />{PAGE_NUMBER}</div>
    </div>
    <div class="row"> 
      <div class="col pl-3 my-auto nav"><a href="{U_INDEX}">{L_INDEX}</a>{NAV_CAT_DESC}</div>
      <div class="col gensmall text-end pr-0">{S_TIMEZONE}</div>
    </div>
  </div>
