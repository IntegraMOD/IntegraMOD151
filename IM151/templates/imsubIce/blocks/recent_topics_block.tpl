<table border="0" cellpadding="0" cellspacing="1" width="100%">
	<tr>
		...
		&raquo; <a href="{scroll.recent_topic_row.U_TITLE}"><b>{scroll.recent_topic_row.L_TITLE}</b></a><br />
		by <a href="{scroll.recent_topic_row.U_POSTER}">{scroll.recent_topic_row.S_POSTER}</a> on {scroll.recent_topic_row.S_POSTTIME}<br /><br />
