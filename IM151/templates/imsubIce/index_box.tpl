...
<div class="container-fluid forumline">
  <div class="row th">
	<div class="col pt-1 text-start">{catrow.tablehead.L_FORUM}</div>
...
<!-- BEGIN cat -->
  <div class="row catHead d-flex justify-content-end">
	...
	<div class="col-3 nb text-end"></div>
  </div>
<!-- END cat -->
<!-- BEGIN forumrow -->
  <div class="row row2" onMouseOver="this.className='row row1'" onMouseOut="this.className='row row2'">
 	<!-- BEGIN inc -->
