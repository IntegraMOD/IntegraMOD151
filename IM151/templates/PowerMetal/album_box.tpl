...
<table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
   ...
   <td width="100%" background="templates/PowerMetal/images/blk_tm.gif"><span class="genmed2"><center>{catheader.L_PUBLIC_CATS}</center><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
