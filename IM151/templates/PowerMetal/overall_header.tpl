...
<tr>
<td align="right" width="16"><img src="templates/PowerMetal/images/logo_L.gif" height="124" width="16" title="" border="0" alt="" /></td>
<td>
...
<!-- END switch_banner_0 -->
<td align="center"><img src="images/spacer.gif" height="1" width="1" title="" border="0" alt="" /></td>
</tr>
</table>
</td>
<td align="left" width="97"><img src="templates/PowerMetal/images/logo_R.gif" height="124" width="97" title="" border="0" alt="" /></td>
</tr>
</table>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
<tr>
<td align="right"><a href="#bot"><div class="hdr_right"><img src="images/spacer.gif" height="39" width="39" title="{L_TOPIC_UP_IMAGE}" border="0" alt="{L_TOPIC_UP_IMAGE}" /></div></td>
<td width="100%" valign="middle" background="templates/PowerMetal/images/nav_M.gif">{QMENUS}</td>
<td align="left"><a href="#bot"><div class="hdr_left"><img src="images/spacer.gif" height="39" width="39" title="{L_TOPIC_UP_IMAGE}" border="0" alt="{L_TOPIC_UP_IMAGE}" /></div></td>
</tr>
</table>
<br />
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
    <td align="center" class="description"><strong>{SITE_DESCRIPTION}</strong>&nbsp;</td>    
  </tr> 
</table>
...
<!-- END switch_lw_user_logged_in --><br />
