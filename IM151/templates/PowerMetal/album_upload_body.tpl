...
<table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
   ...
   <td width="100%" background="templates/PowerMetal/images/blk_tm.gif"><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""><span class="genmed2"><center>{L_UPLOAD_PIC}</center></td>
...
<!-- END switch_user_logged_out -->
	...
	<!-- BEGIN switch_nuffload_disabled -->
		<tr>
			...
			<td class="row2">
				<span id="addbutton" class="gen"><input type="button" value="{L_ADD_FILE}" onClick="AddFileField()" class="liteoption" /></span><br /><br />
	...
	<tr>
		<td height="28" class="row1"><span class="gen">{L_ROTATION}:</span></td>
