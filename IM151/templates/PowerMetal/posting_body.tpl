...
<table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
   ...
   <td align="center" width="100%" background="templates/PowerMetal/images/blk_tm.gif"><strong>{L_POST_A}<strong><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
