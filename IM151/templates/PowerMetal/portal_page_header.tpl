...
<td valign="top" style="width:{HEADER_WIDTH}px !important;">
...
<!-- BEGIN header_blocks_row -->
 <table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   ...
   <td width="100%" background="templates/PowerMetal/images/blk_tm.gif"><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""><span class="genblock">{header_blocks_row.title.TITLE}</span></td>
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
      ...
      <tr>
        ...
        class="row1" 
        <!-- END background -->
		><div id="block1_{header_blocks_row.BLOCKID}" style="position: relative;">{header_blocks_row.OUTPUT}</div><!-- BEGIN openclose --><a class="openclose" href="javascript:ShowHide('block1_{header_blocks_row.BLOCKID}','block2_{header_blocks_row.BLOCKID}','block3_{header_blocks_row.BLOCKID}');">&nbsp;</a><!-- END openclose -->
		</td>
 	  </tr> 
    </table>
</td>
