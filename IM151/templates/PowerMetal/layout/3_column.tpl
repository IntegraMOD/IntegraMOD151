...
<!-- BEGIN center_blocks_row -->
 <table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   <td><img name="blkl" src="templates/PowerMetal/images/blk_tlc.gif"WIDTH=8 HEIGHT=23 border="0" alt=""></td> 
   <td width="100%" background="templates/PowerMetal/images/blk_tm.gif"><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""><span class="genblock">{center_blocks_row.title.TITLE}</span></td>
   <td><img name="blkr" src="templates/PowerMetal/images/blk_trc.gif" WIDTH=77 HEIGHT=23 border="0" alt=""></td>
  </tr>
  		<!-- END title -->
 </table>
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
      ...
      <tr>
        ...
        class="row1" 
        <!-- END background -->
		><div id="block1_{center_blocks_row.BLOCKID}" style="position: relative;">{center_blocks_row.OUTPUT}</div><!-- BEGIN openclose --><a class="openclose" href="javascript:ShowHide('block1_{center_blocks_row.BLOCKID}','block2_{center_blocks_row.BLOCKID}','block3_{center_blocks_row.BLOCKID}');">&nbsp;</a><!-- END openclose -->
		</td>
 	  </tr> 
    </table>
</td>
...
<!-- BEGIN right_blocks_row -->
 <table class="blk" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   <td><img name="blkl" src="templates/PowerMetal/images/blk_tlc.gif"WIDTH=8 HEIGHT=23 border="0" alt=""></td> 
   <td width="100%" background="templates/PowerMetal/images/blk_tm.gif"><img name="blkm" src="templates/PowerMetal/images/spacer.gif" width="1" height="1" border="0" alt=""><span class="genblock">{right_blocks_row.title.TITLE}</span></td>
   <td><img name="blkr" src="templates/PowerMetal/images/blk_trc.gif" WIDTH=77 HEIGHT=23 border="0" alt=""></td>
  </tr>
  		<!-- END title -->
 </table>
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
      ...
      <tr>
        ...
        class="row1" 
        <!-- END background -->
		><div id="block1_{right_blocks_row.BLOCKID}" style="position: relative;">{right_blocks_row.OUTPUT}</div><!-- BEGIN openclose --><a class="openclose" href="javascript:ShowHide('block1_{right_blocks_row.BLOCKID}','block2_{right_blocks_row.BLOCKID}','block3_{right_blocks_row.BLOCKID}');">&nbsp;</a><!-- END openclose -->
		</td>
 	  </tr> 
    </table>
</td>
