  ...
  <table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
    <tr>
        ...
        <span class="gensmall">{L_NEW_ONLY_DESC}</span></td>
          ...
          <tr>
            <td class="row1" style="padding: 5px;"><span class="gen">{L_SEND_HOUR}</span><br />
        <span class="gensmall">{L_SEND_HOUR_DESC}</span></td>
            <td class="row2" style="padding: 5px;">
          ...
          <tr>
            ...
            <td class="row2" style="padding: 5px;">
              ...
              <div id="dynamicforums">
                <!-- BEGIN forums -->
                <input type="checkbox" name="{forums.FORUM_NAME}" {forums.CHECKED} onclick="toggleAllForums ();" /> <span class="gen">{forums.FORUM_LABEL}</span><br />
                <!-- END forums -->
              </div>
            </td>
          </tr>
          <tr>
            <td colspan="2" align="center" class="cat" height="28"><input type="hidden" name="create_new" value="{DIGEST_CREATE_NEW_VALUE}" /><button type="submit" class="mainoption"><span class="gen">{L_SUBMIT}</span></button>&nbsp;<button type="reset" class="liteoption"><span class="gen">{L_RESET}</span></button></td>
          </tr>
        </table>
      </form> 