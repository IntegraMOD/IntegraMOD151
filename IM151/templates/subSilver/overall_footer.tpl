        ...
        <tr>
	      <td colspan ="10">
		    <table class="btmnav" cellpadding="0" cellspacing="0">
		      <tr>
		        ...
		        <td align="center" width="100%" class="">{QMENUS}</td>
		  ...
		  <div align="center"><span class="copyright"><br />{COOKIES_LINK}<br /><br />{ADMIN_LINK}<br />
			<!--
			...
			You must retain the 3 links for phpBB, IntegraMOD and forumimages. These conditions are part of the license this software is released under.  Replace forumimages with the link to the theme author if you are using another theme.
			masterdavid : 2004
			// -->
			...
			<!-- END switch_user_logged_in -->{TRANSLATION_INFO}</span>
		  </div>
          <br />
