				...
				<td class="{postrow.ROW_CLASS}" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td align="right" valign="top" nowrap="nowrap">{postrow.QUOTE_IMG}{postrow.EDIT_IMG}<a href="#top"><img src="{ICON_UP_IMAGE}" alt="{L_BACK_TO_TOP}" title="{L_BACK_TO_TOP}" /></a>{postrow.DELETE_IMG}{postrow.IP_IMG}{postrow.U_R_CARD}{postrow.U_Y_CARD}{postrow.U_G_CARD}{postrow.U_B_CARD}{postrow.CARD_EXTRA_SPACE}{postrow.CARD_HIDDEN_FIELDS}&nbsp;</td>
							<!-- Start add - Yellow card admin MOD -->
							</form>
							<!-- End add - Yellow card admin MOD -->
						</tr>
...
-->
	...
	<table border="0" cellpadding="0" cellspacing="0" class="tbl">
		<tr>
			<td class="tbll"><img src="images/spacer.gif" alt="" width="8" height="4" /></td><td class="tblbot"><img src="images/spacer.gif" alt="" width="8" height="4" /></td>
