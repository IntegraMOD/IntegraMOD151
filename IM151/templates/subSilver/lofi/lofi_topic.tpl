...
<span class='posttopbar' width="100%" colspan="12" valign="bottom" nowrap="nowrap">
<table cellspacing="0" cellpadding="0" border="0" height="18" width="100%">
<tr>{postrow.BUTTONS_PANEL}
<td align="right" width="100%">
<span class="gensmall">
<a href="{postrow.DOWNLOAD_POST}" class="gensmall" title="{L_DOWNLOAD_POST}">
{L_DOWNLOAD_POST}
