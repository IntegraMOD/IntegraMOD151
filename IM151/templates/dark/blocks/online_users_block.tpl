...
<br /><br />
<span class="gensmall" align="center">[ <a href="{U_IM_LAUNCH}" target="prillian" onClick="javascript:prill_launch('{U_IM_LAUNCH}', '{IM_WIDTH}', '{IM_HEIGHT}'); return false">{L_IM_LAUNCH}</a> ]</span><br />
<span class="gensmall" align="center">[<a href="{U_CONTACT_MAN}">{L_CONTACT_MAN}</a>]</span>
