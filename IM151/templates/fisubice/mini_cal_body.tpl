...
<table width="100%" cellpadding="0" cellspacing="1" border="0">
    <tr>
        <td align="center" class="cat th" height="28">
    ...
    <tr>
		<td class="row1" align="center">
			<table width="100%">
				<tr>
					<td align="left" colspan="2">{U_PREV_MONTH}</td><td colspan="3" align="center"><span class="genmed">{L_MINI_CAL_MONTH}</span></td><td align="right" colspan="2">{U_NEXT_MONTH}</td>
				</tr>
				<tr>
    ...
    <!-- BEGIN switch_mini_cal_add_events -->
    <tr>
	    <td class="row1" height="28" align="center">
			<span class="genmed">
