...
<table class="forumline" cellspacing="1" cellpadding="4" border="0" align="center" width="50%">
	<tr> 
	  <td class="cat" colspan="2" align="center" height="28"><span class="cattitle">{L_PACKAGE_MODULE}</span> 
	  </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="cat" colspan="2" align="center">{S_HIDDEN_FIELDS}<input class="mainoption" name="submit" type="submit" value="{L_CREATE}" /></td>
	</tr>
</table></form>
