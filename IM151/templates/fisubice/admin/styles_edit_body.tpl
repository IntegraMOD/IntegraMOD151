<div class="maintitle">{L_THEMES_TITLE}</div>
<br />
<div class="genmed">{L_THEMES_EXPLAIN}</div>
<br />
...
<th height="28">{L_VALUE}</th>
<th>{L_SIMPLE_NAME}</th>
</tr>
<tr> 
<td class="row1" align="right" nowrap="nowrap">{L_STYLESHEET}:<br />
<span class="gensmall">Filename for CSS stylesheet<br />
