      ...
      <div class="container-fluid">
	    <div class="row">
	      <div class="col px-0 align-top">
            ...
            <!-- BEGIN title -->
            <div class="row th pt-2 pl-1">{center_blocks_row.title.TITLE}</div>
            <!-- END title -->
            ...
            <div class="row th pt-2">
		      <div class="col px-0 text-right">
		        <img src="{center_blocks_row.title_image.TITLE}" alt="" >
			  </div>
		    </div>
            <!-- END title_image -->
      ...
      <div class="container-fluid ctr" style="min-width:126px !important;">
	    <div class="row">
    	  ...
    	  <div class="col px-0 align-top">
            ...
            <!-- Shown when the title is text -->
            <!-- BEGIN title -->
            <div class="row th pt-2 pl-1">{right_blocks_row.title.TITLE}</div>
            <!-- END title -->
            ...
            <div class="row th pt-2">
		      <div class="col px-0 text-right">
		        <img src="{right_blocks_row.title_image.TITLE}" alt="" >
			  </div>
		    </div>
            <!-- END title_image -->
	          <div class="row">
