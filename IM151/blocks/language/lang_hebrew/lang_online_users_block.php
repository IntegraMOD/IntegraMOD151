...
/***************************************************************************
 *                      lang_online_users_block.php [Hebrew]
 *                              -------------------
...
$lang['Title_online_users'] = 'מי מחובר';
$lang['View_complete_list'] = 'צפה ברשימה המלאה';
$lang['None'] = 'ללא';
...
$lang['Record_online_users'] = 'מספר המשתמשים הכי גדול שהיה מחובר בו זמנית הוא <b>%s</b> ב-%s';
$lang['How_Many_Chatters'] = 'ישנם <b>%d</b> משתמשים מחוברים בצ\'אט עכשיו.';
$lang['Click_to_join_chat'] = 'לחץ כדי להצטרף לצ\'אט';
$lang['Login_to_join_chat'] = 'אנא התחבר לפורומים כדי להשתמש בצ\'אט';
?>